...
<map name="Map">
    <area shape="rect" coords="685,8,744,27" href="http://github.com/PassionZale/pursey">
    <area shape="rect" coords="613,9,666,27" onClick="this.style.behavior='url(#default#homepage)';this.setHomePage('http://github.com/PassionZale/');">
    <area shape="rect" coords="535,8,593,26" href="javascript:window.external.AddFavorite('http://github.com/PassionZale/pursey",'九九度供求信息网')">
